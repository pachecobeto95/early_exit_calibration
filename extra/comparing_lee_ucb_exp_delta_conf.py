...
if __name__ == "__main__":
	...
	parser.add_argument('--n_rounds', type=int, default=1000000, help='Model Id (default: 1000000)')
	...
	verbose = False
	savePath = os.path.join(".", "comparing_lee_ucb_bin_delta_conf_result_c_%s_id_%s.csv"%(args.c, args.model_id))
	logPath = os.path.join(".", "logLEEComparingUCBDeltaConfBin_%s.txt"%(args.model_id))
