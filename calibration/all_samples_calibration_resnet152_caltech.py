...
def expOverallCalibration(model, val_loader, test_loader, device, p_tar_list, model_path, result_path, saveTempPath):
	for p_tar in p_tar_list:
		...
		scaled_model = ModelAllSamplesCalibration(model, device, model_path, saveTempPath)
...
result_path =  os.path.join(save_path, "results", "calib_all_samples_branches_exp_data_%s.csv"%(model_id))
