...
def expOverallCalibration(model, val_loader, test_loader, device, p_tar_list, model_path, result_path, saveTempPath):
	for p_tar in p_tar_list:
		...
		scaled_model = ModelBranchesCalibration(model, device, model_path, saveTempPath)
...
expOverallCalibration(early_exit_dnn, val_loader, val_loader, device, p_tar_list, model_path, result_path, saveTempOverallPath)
